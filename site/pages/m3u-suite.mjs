    ...
    <section class="section container" id="faq">
      ...
      <div class="faq-list">
        ...
        <details class="faq-item reveal">
          ...
          <p>
            m3u tv is built with Flutter and runs on iOS, Apple TV, Android, Android TV,
            macOS, Linux, and Windows. See
            <a href="/m3u-suite/m3u-tv/">screenshots, downloads, and app store links →</a>.
          </p>
        </details>
      </div>
    </section>
